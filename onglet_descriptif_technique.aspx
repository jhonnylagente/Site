          ...
          <fieldset class="fieldset_10champs" id="fieldset_CaracPrincip">
                ...
                <table>
                    ...
                    <tr id="surface_habitable">
                        ...
                        <td class="markerHabitable">Surface habitable<span class="rouge">*</span></td>
                        <td class="markerHabitable"><asp:TextBox ID="TextBoxSurfaceHabitable" runat="server"  CssClass=" tb40" onchange='javascript:checkfield_num("balise_spoiler31", this.value)'></asp:TextBox>
						<span id="balise_spoiler31" class="balise_spoiler"><img class="croix_rouge" src="../img_site/croix_rouge.png" /></span></td>

                    
                        <td id="surface_carrez" class="markerSurface">Surface carrez</td>
                        <td class="markerSurface"><asp:TextBox ID="TextBoxSurfaceCarrez" runat="server" CssClass=" tb40" onchange='javascript:checkfield_num("balise_spoiler32", this.value)'></asp:TextBox>
...
<!-- ******************************************* Affichage pour Maison/Appartement/Terrain ************************************************************ -->
          ...
          <fieldset class="fieldset_6champs" id="fieldset_InfoCompl">
                ...
                <table>
                    ...
                    <tr>
                        <td class="optionTerrain" id="eau"><asp:CheckBox ID="CheckBoxEau" runat="server"  Text="Eau" Checked="True" /></td>
                    </tr>

                    <tr>
                        <td class="optionTerrain"id="gaz"><asp:CheckBox ID="CheckBoxGaz" runat="server"  Text="Gaz" Checked="True" /></td>
                    </tr>

                    <tr class="optionTerrain" id="electricite">
                        <td><asp:CheckBox ID="CheckBoxElectricite" runat="server" Text="Electricite" Checked="True" /></td>
                    </tr>
 
                    <tr class="optionTerrain" id="tout_a_legout">
                  ...
                  <!--                  
                    ...
                    <tr class="optionTerrain" id="numero_lotissement" onchange='javascript:checkfield_num("balise_spoiler51", this.value)'>
          ...
          <div class="contenu_DescriptifTechnique">
            ...
            <fieldset class="fieldset_12champs" id="fieldset_DispoInt">
                ...
                <legend><strong>Disposition intérieure</strong></legend>    
                        ...
                        <span class="optionAppart" id="ascenseur"><asp:CheckBox ID="CheckBoxAscenseur" runat="server"  Text="Ascenseur" /></span>
                        <span class="optionAppart" id="balcon" style="margin-left:10px"><asp:CheckBox ID="CheckBoxBalcon" runat="server"  Text="Balcon" /></span>
