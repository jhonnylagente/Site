<%@ Page Language="C#" MasterPageFile="~/pages/MasterPage.master" AutoEventWireup="true" CodeFile="venteListe.aspx.cs" Inherits="venteListe" Title="Liste des ventes" %>
...
<script type="text/javascript" src="../Javascript/venteListe.js"></script>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" 
         ...
         <Columns>
			...
			<asp:TemplateField HeaderStyle-CssClass="Entet">
				...
				<ItemTemplate>
                    <asp:ImageButton ID="buttonDelete" runat="server" OnClientClick="return confirmDeleteVente();" OnClick="deleteVente" ImageUrl="../img_site/trash.png" CssClass="croix_rouge"/>
					<div class='tooltip'><span>Supprimer la vente</span></div>
				</ItemTemplate>
            </asp:TemplateField>
    ...
    <div class="tamid">
      ...
      <asp:Button runat="server" ID="button1" class="myButton"  OnClick="buttonValiderVente" Text="Valider/Invalider vente" />&nbsp;&nbsp;
