<%@ Page Language="C#" MasterPageFile="~/pages/MasterPage.master" AutoEventWireup="true"
    ...
    Title="PATRIMONIUM : Modifier mes coordonnées" ValidateRequest="false" %>
...
<script type="text/javascript">
    ...
    function checksize_field(id_pers,id_texte, value, max_size) {
        ...
        if (reste >= 0) {
            document.getElementById(id_pers).innerHTML = "<i><font size='2px'> Reste " + reste + " caractères </font></i>";
        }
        else {
            document.getElementById(id_pers).innerHTML = "<i><font size='2px'> Reste 0 caractères </font></i>";
