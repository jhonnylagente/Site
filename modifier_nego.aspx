<%@ Page Language="C#" MasterPageFile="~/pages/MasterPage.master" AutoEventWireup="true" CodeFile="modifier_nego.aspx.cs" Inherits="pages_ajout_nego" Title="PATRIMONIUM : Mon espace client" %>
...
<div class="boutonMilieu">
   ...
   <%  Membre member = (Membre)Session["Membre"];
       ...
       if ((nego == member.PRENOM + " " + member.NOM && member.STATUT == "nego") || member.STATUT == "ultranego")
       { 
        %>
      ...
      &nbsp;
      <asp:Button ID="BoutonAjouter" runat="server" Text="Modifier le bien" OnClientClick="return validerForm();" OnClick="ButtonModifierBien_Click1" CssClass="myButtopetiteajouter" style="text-align:center;height:20px;margin-top:2px" />  
      &nbsp;
	  <%} %>          
            ...
            <fieldset class="fieldset_2champs">
                ...
                <table>
                    <tr>
                        ...
                        <%
                            //Membre member = (Membre)Session["Membre"];
							String requet = "SELECT Biens.negociateur, Biens.ref FROM Biens WHERE ((Biens.ref)='" + reference_bien + "')";
            ...
            <fieldset class="fieldset_5champs" style="height:195px;">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><asp:TextBox ID="TextBoxCodePostalBien" runat="server" CssClass="tbsanswidth" onblur='viderListeDeroulante(0)' onkeyup='listeCP(this,0)' onchange='javascript:checkfield_num("balise_spoiler2", this.value)'></asp:TextBox> </td> 
                    ...
                    <tr>
                        ...
                        <td><asp:TextBox ID="TextBoxVilleBien" runat="server" CssClass="tbsanswidth" onblur='viderListeDeroulante(0)' onkeyup='listeVilles(this,0)' onchange='javascript:checkfield_alpha("balise_spoiler3", this.value)' ></asp:TextBox></td>
                    ...
                    <tr>
                        ...
                        <td><asp:TextBox ID="TextBoxLocalisationBien" placeholder="Centre-ville, ..." runat="server" CssClass=" tb200"  onchange='javascript:checkfield_alpha_num("balise_spoiler4", this.value)'></asp:TextBox></td>            
                        <td id="balise_spoiler4" class="balise_spoiler"><img class="croix_rouge" src="../img_site/croix_rouge.png" /></td>
                    </tr>
                    <tr>
                        <td class="cellulePer" colspan=2><br /><span class="rouge">*</span> : Champs obligatoires</td>
                    </tr>
                </table>
            </fieldset >
         </div>
         <div class="contenu_mandatD">
            <fieldset class="fieldset_8champs" style="height:294px;">
                ...
                <%
					...
					String requett = "SELECT DISTINCT Biens.idclient, Clients.idclient, Biens.ref, Biens.negociateur FROM Biens LEFT JOIN Clients ON Biens.idclient = Clients.idclient WHERE ((((Biens.ref)='" + refel + "')) AND (((Biens.negociateur)='" + member.PRENOM + " " + member.NOM + "'))) GROUP BY Biens.idclient, Clients.idclient, Biens.ref, Biens.negociateur";
					System.Data.DataSet ds1 = null;
					c = null;
					c = new Connexion(System.Configuration.ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString);
					c.Open();
					ds1 = c.exeRequette(requett);
					c.Close();
					c = null;
                    ...
                    foreach (System.Data.DataRow ligne in dr)
                    {
                        ...
                        if (ligne["negociateur"].ToString().ToUpper() == member.PRENOM.ToUpper() + " " + member.NOM.ToUpper() || member.STATUT == "ultranego")
                        {
				...
				%>
                   <table>
                    ...
                    <td>
                        ...
                        <ContentTemplate>
                            <asp:DropDownList ID="DropDownListTypeMandat" runat="server" CssClass=" tb200"  OnSelectedIndexChanged="TypeMandatChange" onchange='javascript:checkfield_alpha("balise_spoiler6", this.value)'  AutoPostBack="true">
                        </asp:DropDownList>   
                    ...
                    <tr>      
                        <td>Disponibilité</td>    
                        <td><asp:TextBox ID="TextBoxDisponibilite" runat="server" CssClass=" tb200"  placeholder="Libre | Date de dispo" onchange='javascript:checkfield_alpha_num("balise_spoiler7", this.value)'></asp:TextBox></td> 
                        <td id="balise_spoiler7" class="balise_spoiler"><img class="croix_rouge" src="../img_site/croix_rouge.png" /></td>
                    </tr>
                    
                   <tr>   
                        <td>Montant du loyer</td>
                        <td><asp:TextBox ID="TextBoxMontantLoyer" runat="server" CssClass=" tb200" placeholder="Loyer présent ou passé" onchange='javascript:checkfield_num("balise_spoiler8", this.value)'></asp:TextBox> </td>  
      ...
      <!-- ONGLET VALIDER -->
        <div class="contenu_onglet" id="contenu_onglet_valider">
            <div class="ModifierBien">
             <% 
               if (nego == member.PRENOM + " " + member.NOM || member.STATUT == "ultranego")
               { 
                %>
