<%@ Page Language="C#" MasterPageFile="~/pages/MasterPage.master" AutoEventWireup="true" CodeFile="completerprofil.aspx.cs" Inherits="pages_monCompte" Title="PATRIMONIUM : Mon espace client" %>
    ...
    <tr >
        ...
        <td  class="moncompteProfilPicture">
            <%
                ...
                <asp:Button ID="ButtonAddProfilPhoto" runat="server" Text="Valider" OnClick="ButtonAddProfilPicture"/> 
            <%} %>
        </td>
    </tr>
</table>
