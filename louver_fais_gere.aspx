<%@ Page Language="C#" MasterPageFile="~/pages/MasterPage.master" AutoEventWireup="true"
    CodeFile="louver_fais_gere.aspx.cs" Inherits="louver_fais_gere" Title="PATRIMONIUM : Louver__fais_gere" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table>
        ...
        <tr>
            <td>
                <center>
                    <asp:Button ID="Buttonlestimer" runat="server" Text="Envoyer" CssClass="myButton"
                        OnClick="Buttonlestimer_Click" Height="35px" Width="150px" /></center>
            </td>
        </tr>
        <tr>
            <td>
