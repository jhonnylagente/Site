...
public partial class pages_ajout_nego : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        racine_site = (String)ds2.Tables[0].Rows[0]["Chemin_racine_site"];
    ...
    private Boolean checkField(Bien bien)
    {
        ...
        /*Connexion c = new Connexion(System.Configuration.ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString);
        c.Open();
        System.Data.DataSet ville = c.exeRequette("Select Nom,[Code Postal] FROM Ville");
        System.Data.DataSet arrondissement = c.exeRequette("Select Nom,[Code Postal] FROM Arrondissement");
        System.Data.DataSet pays = c.exeRequette("Select Titre_Pays FROM Pays");
        c.Close();
     ...
     //    booltbCommentaires = tbCommentaires.Text.Trim() == "" || alphaNumReg.IsMatch(tbCommentaires.Text.Trim());
        ...
        //On attribut les valeurs des champs a l'objet bien
        #region try...catch
         ...
         try
         {
             ...
             bien.NUM_AGENCE = member.NUM_AGENCE;
         }
         ...
         //try { bien.CODE_POSTAL_VENDEUR = int.Parse(TextBoxCodePostalVendeur.Text.Replace(" ","")); }
         //catch { bien.CODE_POSTAL_VENDEUR = 0; }
         try { bien.CODE_POSTAL_VENDEUR = TextBoxCodePostalVendeur.Text; }
    ...
    protected void ButtonAddBien_Click1(object sender, EventArgs e)
    {
        ...
        if (checkField(bien))
        {
            ...
            if (FileUpload(sender, e))
            {
                ...
                Membre member1 = new Membre();
                member1 = (Membre)Session["Membre"];
				Response.Write(bien.ToString());
                BienDAO.addBien(bien, false, member1.STATUT);
            ...
            else LabelErrorLogin.Text = " Erreur lors du chargement des photos, seul les photos .jpg sont acceptées <br />";
        }
}
