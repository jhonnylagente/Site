<%@ Page Language="C#" MasterPageFile="~/pages/MasterPage.master" AutoEventWireup="true" CodeFile="modifierCompte.aspx.cs" Inherits="pages_ajout_acquereur" Title="PATRIMONIUM : Mon espace client"%>
        ...
        <div id="mapoffranceAgent">
                <div id="francemap" >
                     <div >
                        ...
                        <img id="department" src="../imagemap/blank.png" width="275" height="281" 
                             border="0" 
                            usemap="#Map"/>
                     </div>
...
<table cellspacing="10"> 
    <td class="RechercheAgent" align="center" style="width: 800px; text-align:center;">
        <strong><div style='font-family:PT Sans-Serif;font-weight: bold; font-size:30px'>Modifier Agent</div></strong>
        <br/>
    </td>
    <tr>
        ...
        <br />
            ...
            Localisation
            <asp:TextBox ID="textBoxVille1" runat="server"></asp:TextBox><br /><br />
            <asp:Button ID="Button1" class='flat-button' runat="server" OnClick="Button1_Click_Tab" Text="Rechercher" /><br />
        </div>
        </td>
        </tr>
            </table>
    ...
    <%
        ...
        String ville = "";
        List<string> villepostal = new List<string>(ville1.Split(' '));
        Regex rCP = new Regex(@"^([0-9][0-9][0-9][0-9][0-9][ ]?)+$");
        Regex rDepartement = new Regex(@"^([0-9][0-9][ ]?)+$");
        string sqlDroitAdmin = "";
        
        //////////////////////
        if (member != null && member.STATUT == "ultranego") sqlDroitAdmin = "  ";
        else sqlDroitAdmin = " AND contractuel = true ";
        
        if (rCP.IsMatch(ville1))
        {
            ville = "Clients.[postal_client] IN (";
        ...
        else if (rDepartement.IsMatch(ville1))
        {
            foreach (string city in villepostal)
            {
                ville = "Clients.[postal_client] Like '" + city + "%' OR ";
            }
            ville = ville.Substring(0, ville.Length - 4);
        }
        else if (ville1.Length > 0)
        {
            ville = "Clients.[ville_client] Like '%" + ville1 + "%' ";
        }

        if (TextBoxNom.Text != "" && textBoxVille1.Text != "")
        {
            sql = "SELECT * FROM Clients WHERE ((Clients.[statut]='nego' OR Clients.[statut]='ultranego') AND (Clients.[nom_client] LIKE '%" + nom + "%' OR Clients.[prenom_client] LIKE '%" + nom + "%') AND " + ville + "";
        }
        else if (TextBoxNom.Text != "" && textBoxVille1.Text == "")
        {
        ...
        {
            sql = "SELECT * FROM Clients WHERE ((Clients.[statut]='nego' OR Clients.[statut]='ultranego') AND " + ville + "";
        }
        else
        {
...
%>
    <table style="width:95%; margin-top:60px;">
        <td style="float:top;">
<%    
    //Response.Write("<div class='aff-suiv-pages'>");
...
<%
    ...
    if (nbPage >= 1)
    {
        ...
        //---------------------------------------------------------------------------------
        //Response.Write("<div class='aff-suiv-pages'>");
        Response.Write("<center><a href=\"./modifierCompte.aspx?page=" + Convert.ToString(page - 1) + "\" >Page précédente <<</a> ");
        if (page == 1)
        {
            Response.Write("<strong><a href=\"./modifierCompte.aspx?page=1\" >1</a></strong>");
        }
        else
        {
            Response.Write("<a href=\"./modifierCompte.aspx?page=1\" >1</a>");
        }
        for (int i = 2; i <= (nbPage); i++)
        {
            if (i == page)
            {
                Response.Write(" | <strong><a href=\"./modifierCompte.aspx?page=" + Convert.ToString(i) + "\" >" + Convert.ToString(i) + "</a></strong>");
            }
            else
            {
                Response.Write(" | <a href=\"./modifierCompte.aspx?page=" + Convert.ToString(i) + "\" >" + Convert.ToString(i) + "</a>");
            }
        }
        Response.Write(" <a href=\"./modifierCompte.aspx?page=" + Convert.ToString(page + 1) + "\" >>> Page suivante</a></center>");//AJOUTER FIN DIV
        ////////////////////////////////////////////
        
        //Response.Write("<div class='aff-suiv-pages'>");TD FIN TD APRES
    }
            %>
            </td>
            <td style="float:right;"> 
                                    ...
                                    </td><td style="float:right;margin-right:10px">
			<%
                ...
                <table style="margin-left:5px;width:100%;margin-right:20px">
    <tr>
         <td style="width: 740px" class="cellulePer">
                <%
                // Div contenant tous les résultats 
                Response.Write("<div id='aff-result'>");
                ...
                while (cl.MoveNext())
                {
                    ...
                    Response.Write(
                             ...
                             //        + ((member != null && member.STATUT == "ultranego" && cl.Current.Contractuel == true) ? "" : "")
                                     //   + "<a href='./afficherCompte.aspx' ><img src=\"../img_site/editer.png\" alt=\"Google Maps\" /> Modifier </a>"
                             ...
                             //               + "<img src=\"../img_site/editer.png\" alt=\"Google Maps\" /> <input type=\"button\" style=\"width:150px;\" onclick=\"clickModi('" + cl.Current.IDCLIENT + "')\" class=\"myButton\" value=\"Modifier\" /><br />"
                                      //+ "<img src=\"../img_site/editer.png\" alt=\"Google Maps\" /> <input type=\"button\" style=\"width:150px;\" onclick=\"clickLoc('" + cl.Current.IDCLIENT + "')\" class=\"myButton\" value=\"Modifier\" /><br />"
                                        //+ "<input type=\"button\" style=\"width:200px;\" onclick=\"clickLoc('" + cl.Current.PRENOM_CLIENT + " " + cl.Current.NOM_CLIENT + "')\" class=\"myButton\" value=\"Consulter ses locations\" /><br />"
                    ...
                    if(cl.Current.KBIS_CLIENT != "")
                        Response.Write("<br/>Kbis: " + cl.Current.KBIS_CLIENT );
                    
                    string mail = cl.Current.ID_CLIENT;
                    Response.Write("<br />" + "Mail: <A HREF=mailto:" + cl.Current.ID_CLIENT + ">" + cl.Current.ID_CLIENT + "</a>");

                    Response.Write("<div class=\"Resultat-lien-droit2\">"
                                    + ((member != null && member.STATUT == "ultranego" && cl.Current.Contractuel == true) ? "" : "")
                                    + "<img src=\"../img_site/editer.png\" alt=\"Google Maps\" /> <input type=\"button\" style=\"width:150px;\" onclick=\"clickModi('" + cl.Current.IDCLIENT + "')\" class=\"myButton\" value=\"Modifier\" /><br />"
                                    );
                    Response.Write("</div>");
...
<%--<%
    ...
    <script type="text/javascript">
        ...
        function fillTextBox(departmentId) {
            ...
            var dptb = document.getElementById("<%=textBoxVille1.ClientID %>").value;
            ...
            document.getElementById("<%=textBoxVille1.ClientID %>").value = dpfinal;
        }
