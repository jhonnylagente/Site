<%@ Page Language="C#" MasterPageFile="~/pages/MasterPage.master" AutoEventWireup="true" CodeFile="ajout_nego_loc.aspx.cs" Inherits="pages_ajout_nego" Title="PATRIMONIUM : Mon espace client" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server" >
    ...
    <script type="text/javascript" src="ajout_modif_nego.js"></script>
        ...
        <strong id="error" class="rouge"><asp:Label ID="LabelErrorLogin" runat="server" ForeColor="Red" Visible="False" Width="400px"></asp:Label></strong>
...
<div class="systeme_onglets">
    ...
    <div class="contenu_onglets">
        <div class="contenu_onglet" id="contenu_onglet_mandat" style="height:315px;">
            ...
            <fieldset class="fieldset_2champs">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>Etat du bien</td>
                        <td>
                            <asp:DropDownList ID="DropDownListEtat" runat="server" CssClass="tbsanswidth">
                            </asp:DropDownList> 
                        </td>
                   </tr>                    
                </table>               
            ...
            <fieldset class="fieldset_5champs" style="height:195px;">
                ...
                <table>           
                    ...
                    <tr>
                        ...
                        <td><asp:TextBox ID="TextBoxCodePostalBien"   runat="server" onblur='viderListeDeroulante(0)' onkeyup='listeCP(event,0)' onchange='javascript:checkfield_num("balise_spoiler2", this.value)' CssClass="tbsanswidth"></asp:TextBox> </td> 
                    ...
                    <tr>
                        ...
                        <td><asp:TextBox ID="TextBoxVilleBien" runat="server" onblur='viderListeDeroulante(0)' onkeyup='listeVilles(event,0)'  onchange='javascript:checkfield_alpha("balise_spoiler3", this.value)' CssClass="tbsanswidth"></asp:TextBox></td>
                    ...
                    <tr>
                        ...
                        <td><asp:TextBox ID="TextBoxPaysBien" value="France" runat="server" onblur='viderListeDeroulante(0)' onkeyup='listePays(event,0)' onchange='javascript:checkfield_alpha("balise_spoiler3", this.value)' CssClass="tbsanswidth"></asp:TextBox></td>
                        <td id="balise_spoilerPays" class="balise_spoiler2" > <img class="croix_rouge" src="../img_site/croix_rouge.png" /></td>
                        <td id='saisieautopays0'></td>
                   </tr>      
                    <tr> 
                        <td class="cellulePer">Localisation du bien</td>
                        <td><asp:TextBox ID="TextBoxLocalisationBien" placeholder="Centre-ville, ..." runat="server"  onchange='javascript:checkfield_alpha_num("balise_spoiler4", this.value)' CssClass="tbsanswidth"></asp:TextBox></td>            
         ...
         <div class="contenu_mandatD">    
            <fieldset class="fieldset_8champs" style="height:294px;">
                ...
                <table>
                    ...
                    <td>
                        <asp:DropDownList ID="DropDownListTypeMandat" runat="server"  onchange='javascript:checkfield_alpha("balise_spoiler6", this.value)' CssClass="tbsanswidth">
                        </asp:DropDownList>   
                        </td>
                    ...
                    <tr>  
                        ...
                        <td><asp:TextBox ID="TextBoxDateEcheance"  runat="server" onfocus="HS_setDate(this)" CssClass="tb200"></asp:TextBox></td>
					</tr>
                    <tr>
                        <td>Coup de coeur</td>    
                    ...
                    <tr>      
                        <td>Disponibilité</td>    
                        <td><asp:TextBox ID="TextBoxDisponibilite"  runat="server"  placeholder="Libre | Date de dispo" onchange='javascript:checkfield_alpha_num("balise_spoiler7", this.value)' CssClass="tb200"></asp:TextBox></td> 
                        <td id="balise_spoiler7" class="balise_spoiler"><img class="croix_rouge" src="../img_site/croix_rouge.png" /></td>
                        <!--<td>Montant du loyer</td>
                        <td><asp:TextBox ID="TextBoxMontantLoyer" runat="server" placeholder="Loyer présent ou passé" onchange='javascript:checkfield_num("balise_spoiler8", this.value)' CssClass="tb80"></asp:TextBox> </td>  
                        <td id="balise_spoiler8" class="balise_spoiler"><img class="croix_rouge" src="../img_site/croix_rouge.png" /></td>-->
  
                   </tr>
				   </tr>
                        <td>Date de libération</td>
                        <td><asp:TextBox ID="TextBoxDateLiberation" runat="server" onfocus="HS_setDate(this)" CssClass="tb200"></asp:TextBox></td> 
                    </tr>
                 </table>
            </fieldset>    
         </div>           
         ...
         <div class="contenu_ongletD3">
          <fieldset class="fieldonglet1"> 
                <legend><strong>Texte Publicité</strong></legend>
                    <asp:TextBox ID="TextBoxTextePublicite" runat="server" TextMode="multiline" class="TextePublicite" CssClass="tbsanswidth"></asp:TextBox>
          </fieldset>
         </div>
         <div> 
            <fieldset class="fieldonglet1"> 
                <legend><strong>Texte Mailing</strong></legend>
                <asp:TextBox ID="TextBoxTexteMailing" runat="server" TextMode="multiline" class="TexteMailing" CssClass="tbsanswidth"></asp:TextBox>
            </fieldset>    
...
<div>
<div class="boutonMilieuNew"><asp:Button ID="BoutonAjouter" runat="server" Text="Ajouter le bien" OnClientClick="return validerForm2();" OnClick="ButtonAddBien_Click1" style="padding:6px;" CssClass="myButtopetiteajouter"/></div>
