<%@ Page Title="Mes locations" Language="C#" MasterPageFile="~/pages/MasterPage.master" AutoEventWireup="true" CodeFile="mesLocations.aspx.cs" Inherits="mesLocations" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contentPlaceHolder1" Runat="Server">
    ...
    <div class="Recherche">
		<fieldset class="mid" style="width:92%">
			...
			<div class="paramValue">
				...
				<asp:DropDownList ID="valideLocation" runat="server" CssClass="style2d"> 
					<asp:ListItem Value="2" Text="Tout" /> 
					<asp:ListItem Value="1" Text="Oui" /> 
					<asp:ListItem Value="0" Text="Non" /> 
				</asp:DropDownList>
			...
			<br/>
			<div class="tamid">
                <asp:Button ID="buttonFiltrer" class="myButton"  runat="server" OnClick="filtrer" Text="Filtrer" />
            </div>
		</fieldset>
	</div>
    ...
    <div class="tamid">
        <asp:Label runat="server" ID="gtfo" Visible ="false" Text="Aucun résultat ne correspond à vos critères"></asp:Label>
    </div>
    <div class="gridviewx">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" AllowPaging="true" DataKeyNames="ID" HorizontalAlign="Center"
            ...
            <Columns>
                ...
                <asp:BoundField HeaderText="Loueur" DataField="prenom vendeur" SortExpression="prenom vendeur" HeaderStyle-CssClass="EntetAdresse" />
                ...
                <asp:BoundField HeaderText="Date signature du bail" DataField="date_signature_bail" SortExpression="date_signature_bail" DataFormatString="{0:d}" HeaderStyle-CssClass="EntetAdresse" />
    ...
    <center>
        ...
        <asp:Button ID="boutonsupprimerLocation" runat="server" CssClass="myButton" Text="Supprimer la ou les locations" Visible="true" OnClientClick="return ConfirmationSuppression();"/>
    </center>
    ...
    <div id="popupsuppression" class="popup_block" style="display: none; width: 500px; margin-top: -159.5px; margin-left: -290px;">
	    <p>
            <center>
                ...
                <br/>
                Vous êtes sur le point de supprimer une ou plusieurs location(s), confirmez pour continuer.    
                <br/>
                <br/>
                <asp:Button ID="apply" runat="server" CssClass="myButton" OnClick="deleteLocation" Text="Supprimer" Visible="true" Width="154px" />
                &nbsp;&nbsp;&nbsp;&nbsp;
